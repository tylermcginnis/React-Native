...
4) Custom Babel Setup with React Native
    Video:
      - create /app folder
      - Create index.js in app folder and move index.ios.js code to it file to it
      - Add AppRegistry.regiterComponent to index.ios.js
      - Add AppRegistry.regiterComponent to index.android.js
...
10) React Native iOS Footer Tabs
    ...
    Video:
      - Talk about how the UI is going to be different based on Android or iOS
          - iOS -> Footer
          - Android -> Drawer
